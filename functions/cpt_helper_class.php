...
class Custom_Post_Type
{
	...
	{
		// Capitilize the words and make ist plural
		...
		$labels = array_merge(
			...
			// Default
			array(
				'name'               => _x( $plural, 'post_type_general_name' ),
				'singular_name'      => _x( $name, 'post_type_singular_name' ),
	...
	public function add_taxonomy( $name, $args = array(), $labels = array() )
	{
		if( ! empty( $name ) )
		{
			...
			// We need to know the post type name, so the new taxonomy ca be attached to it.
	...
	public function add_meta_box( $title, $fields = array(), $context = 'normal', $priority = 'default' )
	{
		...
		if( ! empty( $title ) )
		{
			// We need to know the post name again
			$post_type_name = $this->post_type_name;
...
//End of file cpt_helper_class.php
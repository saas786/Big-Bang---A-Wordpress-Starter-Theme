...
// Do not delete these lines
	...
	if ( post_password_required() ) { ?>
		<p class="nocomments"><?php _e('This post is password protected. Enter the password to view comments.', 'big_bang'); ?></p>
	<?php
		return;
	}
?>
...
<?php if ( have_comments() ) : ?>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ( comments_open() ) : ?>
		...
		<p class="nocomments"><?php _e('No Comments.', 'big_bang'); ?></p>

	 <?php else : // comments are closed ?>
		<!-- If comments are closed. -->
		<p class="nocomments"><?php _e('Comments are closed.', 'big_bang'); ?></p>
